    ...
    <div class="top top_sneakers">
      ...
      <div class="baza sneakers">
        ...
        ><input type="number" /><select name="Weapon1">
          ...
          ><option value="0" class="resist" disabled>{{ $store.state.lang.res }} </option></select
        ><input type="number" /><select name="Sneakers2">
          <option value="0" class="atk_sum">{{ $store.state.lang.atk }}+ </option
          ><option value="0" class="hp_sum">{{ $store.state.lang.hp }}+ </option
          ><option value="0" class="def_sum">{{ $store.state.lang.def }}+ </option
          ><option value="0" class="spd" disabled>{{ $store.state.lang.spd }} </option
          ...
          ><option value="0" class="resist" disabled>{{ $store.state.lang.res }} </option></select
        ><input type="number" /><select name="Sneakers3">
          <option value="0" class="atk_sum">{{ $store.state.lang.atk }}+ </option
          ><option value="0" class="hp_sum">{{ $store.state.lang.hp }}+ </option
          ><option value="0" class="def_sum">{{ $store.state.lang.def }}+ </option
          ><option value="0" class="spd" disabled>{{ $store.state.lang.spd }} </option
          ...
          ><option value="0" class="cRate" disabled>{{ $store.state.lang.cRate }} </option
          ><option value="0" class="cDmg" disabled>{{ $store.state.lang.cDmg }} </option
          ><option value="0" class="resist" selected>{{ $store.state.lang.res }} </option></select
        ><input type="number" /><select name="Sneakers4">
          <option value="0" class="atk_sum">{{ $store.state.lang.atk }}+ </option
          ><option value="0" class="hp_sum">{{ $store.state.lang.hp }}+ </option
          ><option value="0" class="def_sum">{{ $store.state.lang.def }}+ </option
          ><option value="0" class="spd" disabled>{{ $store.state.lang.spd }} </option
