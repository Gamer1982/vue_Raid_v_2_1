    ...
    <div class="stats">
      <div class="start startHp">
        <div class="start__stats">
          <input
            v-model="$store.state.options[109]"
            type="number"
            class="stats_input startHp_input"
            placeholder="Start HP"
          /><output class="stats_output startHp_output">+{{ bonusHp }}</output>
        </div>
      ...
      <div class="start startAtk">
        <div class="start__stats">
          <input
            v-model="$store.state.options[110]"
            type="number"
            class="stats_input"
            placeholder="Start ATK"
          /><output class="stats_output">+{{ bonusAtk }}</output>
        </div>
        <div class="start__res">
      ...
      <div class="start startDef">
        <div class="start__stats">
          <input
            v-model="$store.state.options[111]"
            type="number"
            class="stats_input"
            placeholder="Start DEF"
          /><output class="stats_output">+{{ bonusDef }}</output>
        </div>
        <div class="start__res">
      ...
      <div class="start startSpeed">
        <div class="start__stats">
          <input
            v-model="$store.state.options[112]"
            type="number"
            class="stats_input"
            placeholder="Start SPD"
          /><output class="stats_output">+{{ bonusSpd }}</output>
        </div>
        <div class="start__res">
      ...
      <div class="start startCrate">
        <div class="start__stats">
          <input
            v-model="$store.state.options[113]"
            type="number"
            class="stats_input"
            placeholder="Start C.Rate"
          /><output class="stats_output">+{{ bonusCrate }}%</output>
        </div>
        <div class="start__res">
      ...
      <div class="start startCdmg">
        <div class="start__stats">
          <input
            v-model="$store.state.options[114]"
            type="number"
            class="stats_input"
            placeholder="Start C.Dmg"
          /><output class="stats_output">+{{ bonusCdmg }}%</output>
        </div>
        <div class="start__res">
      ...
      <div class="start startResist">
        <div class="start__stats">
          <input
            v-model="$store.state.options[115]"
            type="number"
            class="stats_input"
            placeholder="Start RES"
          /><output class="stats_output">+{{ bonusResist }}</output>
        </div>
        <div class="start__res">
      ...
      <div class="start startAcc">
        <div class="start__stats">
          <input
            v-model="$store.state.options[116]"
            type="number"
            class="stats_input"
            placeholder="Start ACC"
          /><output class="stats_output">+{{ bonusAcc }}</output>
        </div>
        <div class="start__res">
...
export default {
  ...
  watch: {
    options() {
      ...
      let hp_sum =
        options
          .filter((item, i, arr) => arr[i - 1] === "hp_sum")
          .reduce((a, b) => +a + +b) +
        (options[105] === "3" ? 810 : 0) +
        (options[108] === "4" ? 3000 : 0);
      let hp_100 =
        options
          .filter((item, i, arr) => arr[i - 1] === "hp_100")
          .reduce((a, b) => +a + +b) +
        +options[97] +
        +options[103] +
        resultSet
      ...
      let atk_sum =
        options
          .filter((item, i, arr) => arr[i - 1] === "atk_sum")
          .reduce((a, b) => +a + +b) + (options[104] === "1" ? 75 : 0);
      let atk_100 =
        options
          .filter((item, i, arr) => arr[i - 1] === "atk_100")
          .reduce((a, b) => +a + +b) +
        +options[98] +
        +options[103] +
        resultSet
      ...
      let def_sum =
        options
          .filter((item, i, arr) => arr[i - 1] === "def_sum")
          .reduce((a, b) => +a + +b) +
        (options[104] === "3" ? 75 : 0) +
        (options[105] === "1" ? 75 : 0) +
        (options[108] === "2" ? 200 : 0);
      let def_100 =
        options
          .filter((item, i, arr) => arr[i - 1] === "def_100")
          .reduce((a, b) => +a + +b) +
        +options[99] +
        +options[103] +
        resultSet
          ...
          bonusSet;
      let spd = options
        .filter((item, i, arr) => arr[i - 1] === "spd")
        .reduce((a, b) => +a + +b);
      let spd_100 =
        resultSet
          .filter((item, i, arr) => arr[i - 1] === "spd_100")
          .reduce((a, b) => +a + +b) * bonusSet;
      let cRate =
        options
          .filter((item, i, arr) => arr[i - 1] === "cRate")
          .reduce((a, b) => +a + +b) +
        (options[104] === "2" ? 5 : 0) +
        resultSet
          .filter((item, i, arr) => arr[i - 1] === "cRate")
      ...
      let cDmg =
        options
          .filter((item, i, arr) => arr[i - 1] === "cDmg")
          .reduce((a, b) => +a + +b) +
        (options[106] === "1" ? 10 : 0) +
        (options[108] === "1" ? 20 : 0) +
        +options[100] +
      ...
      let resist =
        options
          .filter((item, i, arr) => arr[i - 1] === "resist")
          .reduce((a, b) => +a + +b) +
        (options[104] === "4" ? 10 : 0) +
        (options[105] === "2" ? 10 : 0) +
        (options[108] === "3" ? 50 : 0) +
      ...
      this.bonusHp = Math.round(
        hp_sum + powerHp + (hp_100 * options[109]) / 100
      );
      this.bonusAtk = Math.round(
        atk_sum + powerAtk + (atk_100 * options[110]) / 100
      );
      this.bonusDef = Math.round(
        def_sum + powerDef + (def_100 * options[111]) / 100
      );
      this.bonusSpd =
        Math.round((spd + powerSpd + (spd_100 * options[112]) / 100) * 100) /
        100;
